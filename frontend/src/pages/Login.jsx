...
const Login = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
            ...
            <button className='bg-black text-white font-light px-8 py-2 mt-4 cursor-pointer' type='submit' >{currentState === 'Login' ? 'Sign In' : 'Sign Up'}</button>
            {currentState === 'Login' && <>
                ...
                <a href='https://forever-admin-plum-chi.vercel.app/' target="_blank" rel="noopener noreferrer">
